...
#[derive(Debug)]
pub struct DeFiPulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DeFiPulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DeFiPulse processing");
    
    let mut processor = DeFiPulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DeFiPulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DeFiPulseProcessor::new(false);
